    ...
    if(Utils::isGET()) {
        ...
        foreach($rows as $row) {
            ...
            $html .= "  
                        ...
                        <div data-sku-price='$sku' style='float: none;position: absolute;left: 249px;top: 50px;font-family:nunito;font-weight:bolder;display: inline-block;background-color: #E74C3C;color: #fff;padding: 5px 14px;border-radius: 4px 0 0 4px;'>$price</div>
